...
public class EasyEaseOut implements Interpolator{

    private float startValue;
    private float endValue;

    // Control points for cubic Bezier curve for EasyEaseOut
    private static final float P1_X = 0f;
    private static final float P1_Y = 0.42f;
    private static final float P2_X = 0.58f;
    private static final float P2_Y = 1f;

    private EasyEaseOut(float startValue, float endValue) {
        this.startValue = startValue;
        this.endValue = endValue;
    }

    public static EasyEaseOut get(float startValue, float endValue){
        return new EasyEaseOut(startValue, endValue);
    }
